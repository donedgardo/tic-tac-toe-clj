...
if((i < len)){
var k = (ks[i]);
var G__11744 = cljs.core.assoc.call(null,m,cljs.core.keyword.call(null,k),goog.object.get(o,k));
var G__11745 = (i + (1));
m = G__11744;
i = G__11745;
continue;
...
return ((cljs.core.fn_QMARK_.call(null,c)) && ((!(((function (){var G__11747 = c;
var G__11747__$1 = (((G__11747 == null))?null:G__11747.prototype);
if((G__11747__$1 == null)){
return null;
} else {
return G__11747__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_.call(null,c)) && ((!(((function (){var G__11749 = c;
var G__11749__$1 = (((G__11749 == null))?null:G__11749.prototype);
if((G__11749__$1 == null)){
return null;
} else {
return G__11749__$1.render;
}
})() == null)))));
});
...
var G__11756 = c;
var G__11756__$1 = (((G__11756 == null))?null:G__11756.constructor);
if((G__11756__$1 == null)){
return null;
} else {
return G__11756__$1.displayName;
}
});
...
var _STAR_current_component_STAR__orig_val__11757 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__11758 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__11758);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__11757);
}});
...
var c = this;
var G__11762_11764 = goog.object.get(c,"cljsRatom");
if((G__11762_11764 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__11762_11764);
}
...
var renders_11765 = cljs.core.select_keys.call(null,fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_11766 = cljs.core.first.call(null,cljs.core.vals.call(null,renders_11765));
...
if((cljs.core.count.call(null,renders_11765) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count.call(null,renders_11765))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_.call(null,render_fun_11766)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.call(null,render_fun_11766)].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__11767 = o;
goog.object.set(G__11767,cljs.core.name.call(null,k),v);
