...
var G__13376 = devtools.prefs.pref.call(null,v);
v = G__13376;
continue;
} else {
return v;
...
}catch (e13379){var _e__12387__auto__ = e13379;
return false;
}})();
...
}catch (e13383){var _e__12387__auto__ = e13383;
return false;
}})();
...
}catch (e13385){var _e__12387__auto__ = e13385;
return false;
}}
}
});
...
var vec__13387 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__13387,(0),null);
var name = cljs.core.nth.call(null,vec__13387,(1),null);
...
return cljs.core.some.call(null,(function (p1__13390_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__13390_SHARP_);
}),template);
});
