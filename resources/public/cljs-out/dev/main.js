...
window.CLOSURE_UNCOMPILED_DEFINES = {"figwheel.repl.connect_url":"ws:\/\/localhost:9500\/figwheel-connect?fwprocess=6abac5&fwbuild=dev","cljs.core._STAR_target_STAR_":"bundle"};
...
document.write('<script>goog.require("tic_tac_toe_web.core");</script>');
