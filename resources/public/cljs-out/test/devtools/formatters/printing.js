...
var len__4736__auto___16899 = arguments.length;
var i__4737__auto___16900 = (0);
while(true){
if((i__4737__auto___16900 < len__4736__auto___16899)){
args__4742__auto__.push((arguments[i__4737__auto___16900]));

var G__16901 = (i__4737__auto___16900 + (1));
i__4737__auto___16900 = G__16901;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq16896){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__16897,G__16898,seq16896__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__16902_SHARP_){
return (!((cljs.core.meta.call(null,p1__16902_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.call(null,map__16903__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e16907){var _e__15649__auto__ = e16907;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e16909){var _e__15649__auto__ = e16909;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__16911 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__16912 = devtools.formatters.state.get_current_state.call(null);
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__16912);

try{var map__16913 = opts;
...
var markup_db = cljs.core.get.call(null,map__16913__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__16911);
}});
...
var temp__5718__auto___16918 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5718__auto___16918)){
var managed_print_level_16919 = temp__5718__auto___16918;
var _STAR_print_level_STAR__orig_val__16916_16920 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__16917_16921 = managed_print_level_16919;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__16917_16921);

try{devtools.formatters.state.update_current_state_BANG_.call(null,(function (p1__16915_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__16915_SHARP_,null);
}));

job_fn.call(null);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__16916_16920);
}} else {
job_fn.call(null);
}
