...
var o13271 = temp__5718__auto__;
var temp__5718__auto____$1 = (o13271["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o13272 = temp__5718__auto____$1;
return (o13272["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__12380__auto__ = f;
return (o__12380__auto__["toString"]).call(o__12380__auto__);
} else {
return "";
}
}catch (e13273){var _ = e13273;
return "";
}});
...
try{var o__12380__auto___13275 = t;
(o__12380__auto___13275["cljs$lang$ctorPrWriter"]).call(o__12380__auto___13275,t,writer);
}catch (e13274){var __13276 = e13274;
}
...
var char_code = (function (){var o__12380__auto__ = (new String(char$));
return (o__12380__auto__["charCodeAt"]).call(o__12380__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__12380__auto__ = String;
return (o__12380__auto__["fromCharCode"]).call(o__12380__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__13277 = num_code;
switch (G__13277) {
case (1):
return (185);
...
var o__12380__auto__ = String;
return (o__12380__auto__["fromCharCode"]).call(o__12380__auto__,superscript_code);
});
/**
...
}catch (e13279){var _e__12387__auto__ = e13279;
return false;
}})())){
...
var vec__13280 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__13280,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o13283 = temp__5718__auto__;
var temp__5718__auto____$1 = (o13283["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o13284 = temp__5718__auto____$1;
return (o13284["nameToPath"]);
} else {
return null;
}
} else {
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__13287){
var vec__13288 = p__13287;
var ns_detector = cljs.core.nth.call(null,vec__13288,(0),null);
...
var G__13294 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__13295 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__13294;
remaining_tokens = G__13295;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq13285){
var G__13286 = cljs.core.first.call(null,seq13285);
var seq13285__$1 = cljs.core.next.call(null,seq13285);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__13286,seq13285__$1);
}));
...
var vec__13299 = cljs.core.split_with.call(null,(function (p1__13298_SHARP_){
return cljs.core.not_EQ_.call(null,p1__13298_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__13299,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__13299,(1),null);
...
var vec__13305 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__13305,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__13305,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__13308 = cljs.core.rest.call(null,remaining_tokens);
var G__13309 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__13308;
name_tokens = G__13309;
continue;
} else {
...
var vec__13312 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__13312,(0),null);
var arity = cljs.core.nth.call(null,vec__13312,(1),null);
var vec__13315 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__13315,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__13315,(1),null);
var vec__13318 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__13318,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__13318,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__13318,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__13318,(3),null);
...
var vec__13324 = result;
var munged_ns = cljs.core.nth.call(null,vec__13324,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__13324,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__13324,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__13324,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__13324,(4),null);
var arity = cljs.core.nth.call(null,vec__13324,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__13328 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__13328,(0),null);
var args = cljs.core.nth.call(null,vec__13328,(1),null);
var vec__13331 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__13331,(0),null);
var name = cljs.core.nth.call(null,vec__13331,(1),null);
...
var G__13334 = (arity + (1));
var G__13335 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__13336){
var vec__13337 = p__13336;
var arity = cljs.core.nth.call(null,vec__13337,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__13337,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__13340_SHARP_){
return cljs.core.get.call(null,arities,p1__13340_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__13341_SHARP_){
return cljs.core.drop.call(null,(2),p1__13341_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__13344){
var vec__13345 = p__13344;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__13345,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq13342){
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__13353__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__13353__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__13353__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__13353__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__13354 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__13354,(0),null);
var fn_name = cljs.core.nth.call(null,vec__13354,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__13354,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__13354,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__13354,(4),null);
var arity = cljs.core.nth.call(null,vec__13354,(5),null);
...
var o__12380__auto__ = f;
return (o__12380__auto__["getBasis"]).call(o__12380__auto__);
});
/**
...
}catch (e13358){var _e__12387__auto__ = e13358;
...
var G__13359 = (obj[cljs.core.first.call(null,path)]);
var G__13360 = cljs.core.rest.call(null,path);
obj = G__13359;
path = G__13360;
continue;
} else {
...
var _STAR_ = (function (accum,p__13361){
var vec__13362 = p__13361;
var bit = cljs.core.nth.call(null,vec__13362,(0),null);
var protocol = cljs.core.nth.call(null,vec__13362,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__13365){
var vec__13366 = p__13365;
var ns = cljs.core.nth.call(null,vec__13366,(0),null);
var name = cljs.core.nth.call(null,vec__13366,(1),null);
var selector = cljs.core.nth.call(null,vec__13366,(2),null);
...
var post_process = (function (p__13370){
var vec__13371 = p__13370;
var munged_name = cljs.core.nth.call(null,vec__13371,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__13371,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__13369_SHARP_){
return (obj[cljs.core.first.call(null,p1__13369_SHARP_)]);
}),sorted_matches);
