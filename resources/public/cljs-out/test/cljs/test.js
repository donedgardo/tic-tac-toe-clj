...
var G__12532 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__12532,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__12532;
}
}));
...
/** @this {Function} */
(cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq12534){
var G__12535 = cljs.core.first.call(null,seq12534);
var seq12534__$1 = cljs.core.next.call(null,seq12534);
var G__12536 = cljs.core.first.call(null,seq12534__$1);
var seq12534__$2 = cljs.core.next.call(null,seq12534__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12535,G__12536,seq12534__$2);
}));
...
var file = cljs.core.get.call(null,map__12541__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__12541__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__12541__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,(function (p1__12540_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__12540_SHARP_));
...
var temp__5720__auto___12543 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___12543)){
var message_12544 = temp__5720__auto___12543;
cljs.core.println.call(null,message_12544);
} else {
}
...
var temp__5720__auto___12545 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___12545)){
var message_12546 = temp__5720__auto___12545;
cljs.core.println.call(null,message_12546);
} else {
}
...
var output_dir__$1 = (function (){var G__12547 = output_dir;
if((!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/")))){
return [G__12547,"/"].join('');
} else {
return G__12547;
}
})();
...
var temp__5718__auto__ = ((typeof exception.stack === 'string')?(function (){var G__12549 = exception.stack;
var G__12549__$1 = (((G__12549 == null))?null:clojure.string.split_lines.call(null,G__12549));
var G__12549__$2 = (((G__12549__$1 == null))?null:cljs.core.get.call(null,G__12549__$1,depth));
if((G__12549__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__12549__$2);
}
})():false);
if(cljs.core.truth_(temp__5718__auto__)){
var stack_element = temp__5718__auto__;
var fname = cljs.test.js_filename.call(null,stack_element);
var vec__12550 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__12550,(0),null);
var column = cljs.core.nth.call(null,vec__12550,(1),null);
var vec__12553 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__12553,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__12553,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__12553,(2),null);
...
var m__$1 = (function (){var G__12556 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__12560 = (function (){var G__12559 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__12559);
} else {
return G__12559;
}
})();
...
return cljs.core.vary_meta.call(null,G__12561,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__12565 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__12565,(0),null);
var types = vec__12565;
...
return cljs.core.map.call(null,(function (p__12568){
var vec__12569 = p__12568;
var ns = cljs.core.nth.call(null,vec__12569,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__12569,(1),null);
return (function (){
...
var G__12572 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
var seq__12573 = cljs.core.seq.call(null,vars__$1);
var chunk__12574 = null;
var count__12575 = (0);
var i__12576 = (0);
while(true){
if((i__12576 < count__12575)){
var v = cljs.core._nth.call(null,chunk__12574,i__12576);
var temp__5720__auto___12578 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5720__auto___12578)){
var t_12579 = temp__5720__auto___12578;
each_fixture_fn.call(null,((function (seq__12573,chunk__12574,count__12575,i__12576,t_12579,temp__5720__auto___12578,v,each_fixture_fn,G__12572,G__12572__$1,env,once_fixtures,each_fixtures,vec__12569,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_12579)));
});})(seq__12573,chunk__12574,count__12575,i__12576,t_12579,temp__5720__auto___12578,v,each_fixture_fn,G__12572,G__12572__$1,env,once_fixtures,each_fixtures,vec__12569,ns,vars__$1))
);
} else {
}


var G__12580 = seq__12573;
var G__12581 = chunk__12574;
var G__12582 = count__12575;
var G__12583 = (i__12576 + (1));
seq__12573 = G__12580;
chunk__12574 = G__12581;
count__12575 = G__12582;
i__12576 = G__12583;
continue;
} else {
var temp__5720__auto__ = cljs.core.seq.call(null,seq__12573);
if(temp__5720__auto__){
var seq__12573__$1 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__12573__$1)){
var c__4556__auto__ = cljs.core.chunk_first.call(null,seq__12573__$1);
var G__12584 = cljs.core.chunk_rest.call(null,seq__12573__$1);
var G__12585 = c__4556__auto__;
var G__12586 = cljs.core.count.call(null,c__4556__auto__);
var G__12587 = (0);
seq__12573 = G__12584;
chunk__12574 = G__12585;
count__12575 = G__12586;
i__12576 = G__12587;
continue;
} else {
var v = cljs.core.first.call(null,seq__12573__$1);
var temp__5720__auto___12588__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5720__auto___12588__$1)){
var t_12589 = temp__5720__auto___12588__$1;
each_fixture_fn.call(null,((function (seq__12573,chunk__12574,count__12575,i__12576,t_12589,temp__5720__auto___12588__$1,v,seq__12573__$1,temp__5720__auto__,each_fixture_fn,G__12572,G__12572__$1,env,once_fixtures,each_fixtures,vec__12569,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_12589)));
});})(seq__12573,chunk__12574,count__12575,i__12576,t_12589,temp__5720__auto___12588__$1,v,seq__12573__$1,temp__5720__auto__,each_fixture_fn,G__12572,G__12572__$1,env,once_fixtures,each_fixtures,vec__12569,ns,vars__$1))
);
} else {
}


var G__12590 = cljs.core.next.call(null,seq__12573__$1);
var G__12591 = null;
var G__12592 = (0);
var G__12593 = (0);
seq__12573 = G__12590;
chunk__12574 = G__12591;
count__12575 = G__12592;
i__12576 = G__12593;
continue;
}
} else {
