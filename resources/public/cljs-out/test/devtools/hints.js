...
}catch (e19007){var _e = e19007;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5718__auto___19010 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5718__auto___19010)){
var seen_errors_19011 = temp__5718__auto___19010;
if(cljs.core.truth_(seen_errors_19011.has(self))){
} else {
seen_errors_19011.add(self);

var temp__5720__auto___19012 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5720__auto___19012)){
var sense_19013 = temp__5720__auto___19012;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_19013)].join(''));
} else {
}
}
} else {
