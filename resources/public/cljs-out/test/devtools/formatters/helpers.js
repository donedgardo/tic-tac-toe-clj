...
var G__16842 = devtools.prefs.pref.call(null,v);
v = G__16842;
continue;
} else {
return v;
...
}catch (e16845){var _e__15649__auto__ = e16845;
return false;
}})();
...
}catch (e16849){var _e__15649__auto__ = e16849;
return false;
}})();
...
}catch (e16851){var _e__15649__auto__ = e16851;
return false;
}}
}
});
...
var vec__16853 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__16853,(0),null);
var name = cljs.core.nth.call(null,vec__16853,(1),null);
...
return cljs.core.some.call(null,(function (p1__16856_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__16856_SHARP_);
}),template);
});
