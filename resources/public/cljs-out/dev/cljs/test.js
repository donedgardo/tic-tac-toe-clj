...
var G__11335 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__11335,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__11335;
}
}));
...
var len__4736__auto___11340 = arguments.length;
var i__4737__auto___11341 = (0);
while(true){
if((i__4737__auto___11341 < len__4736__auto___11340)){
args__4742__auto__.push((arguments[i__4737__auto___11341]));

var G__11342 = (i__4737__auto___11341 + (1));
i__4737__auto___11341 = G__11342;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq11337){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__11338,G__11339,seq11337__$2);
}));
...
var map__11344 = m;
var map__11344__$1 = (((((!((map__11344 == null))))?(((((map__11344.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__11344.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__11344):map__11344);
var file = cljs.core.get.call(null,map__11344__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__11344__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__11344__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,(function (p1__11343_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__11343_SHARP_));
...
var temp__5720__auto___11346 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___11346)){
var message_11347 = temp__5720__auto___11346;
cljs.core.println.call(null,message_11347);
} else {
}
...
var temp__5720__auto___11348 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___11348)){
var message_11349 = temp__5720__auto___11348;
cljs.core.println.call(null,message_11349);
} else {
}
...
var output_dir__$1 = (function (){var G__11350 = output_dir;
if((!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/")))){
return [G__11350,"/"].join('');
} else {
return G__11350;
}
})();
...
var temp__5718__auto__ = ((typeof exception.stack === 'string')?(function (){var G__11352 = exception.stack;
var G__11352__$1 = (((G__11352 == null))?null:clojure.string.split_lines.call(null,G__11352));
var G__11352__$2 = (((G__11352__$1 == null))?null:cljs.core.get.call(null,G__11352__$1,depth));
if((G__11352__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__11352__$2);
}
})():false);
if(cljs.core.truth_(temp__5718__auto__)){
var stack_element = temp__5718__auto__;
var fname = cljs.test.js_filename.call(null,stack_element);
var vec__11353 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__11353,(0),null);
var column = cljs.core.nth.call(null,vec__11353,(1),null);
var vec__11356 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__11356,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__11356,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__11356,(2),null);
...
var m__$1 = (function (){var G__11359 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
var G__11359__$1 = (((G__11359 instanceof cljs.core.Keyword))?G__11359.fqn:null);
switch (G__11359__$1) {
case "fail":
...
var G__11363 = (function (){var G__11362 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__11362);
} else {
return G__11362;
}
})();
...
return cljs.core.vary_meta.call(null,G__11364,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
}catch (e11365){var e = e11365;
var G__11366 = e;
var G__11366__$1 = (((G__11366 instanceof cljs.core.Keyword))?G__11366.fqn:null);
switch (G__11366__$1) {
...
var vec__11368 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__11368,(0),null);
var types = vec__11368;
...
return cljs.core.map.call(null,(function (p__11371){
var vec__11372 = p__11371;
var ns = cljs.core.nth.call(null,vec__11372,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__11372,(1),null);
return (function (){
...
var G__11375 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
var G__11375__$1 = (((G__11375 instanceof cljs.core.Keyword))?G__11375.fqn:null);
switch (G__11375__$1) {
case "async":
...
var seq__11376 = cljs.core.seq.call(null,vars__$1);
var chunk__11377 = null;
var count__11378 = (0);
var i__11379 = (0);
while(true){
if((i__11379 < count__11378)){
var v = cljs.core._nth.call(null,chunk__11377,i__11379);
var temp__5720__auto___11381 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5720__auto___11381)){
var t_11382 = temp__5720__auto___11381;
each_fixture_fn.call(null,((function (seq__11376,chunk__11377,count__11378,i__11379,t_11382,temp__5720__auto___11381,v,each_fixture_fn,G__11375,G__11375__$1,env,once_fixtures,each_fixtures,vec__11372,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_11382)));
});})(seq__11376,chunk__11377,count__11378,i__11379,t_11382,temp__5720__auto___11381,v,each_fixture_fn,G__11375,G__11375__$1,env,once_fixtures,each_fixtures,vec__11372,ns,vars__$1))
);
} else {
}


var G__11383 = seq__11376;
var G__11384 = chunk__11377;
var G__11385 = count__11378;
var G__11386 = (i__11379 + (1));
seq__11376 = G__11383;
chunk__11377 = G__11384;
count__11378 = G__11385;
i__11379 = G__11386;
continue;
} else {
var temp__5720__auto__ = cljs.core.seq.call(null,seq__11376);
if(temp__5720__auto__){
var seq__11376__$1 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__11376__$1)){
var c__4556__auto__ = cljs.core.chunk_first.call(null,seq__11376__$1);
var G__11387 = cljs.core.chunk_rest.call(null,seq__11376__$1);
var G__11388 = c__4556__auto__;
var G__11389 = cljs.core.count.call(null,c__4556__auto__);
var G__11390 = (0);
seq__11376 = G__11387;
chunk__11377 = G__11388;
count__11378 = G__11389;
i__11379 = G__11390;
continue;
} else {
var v = cljs.core.first.call(null,seq__11376__$1);
var temp__5720__auto___11391__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5720__auto___11391__$1)){
var t_11392 = temp__5720__auto___11391__$1;
each_fixture_fn.call(null,((function (seq__11376,chunk__11377,count__11378,i__11379,t_11392,temp__5720__auto___11391__$1,v,seq__11376__$1,temp__5720__auto__,each_fixture_fn,G__11375,G__11375__$1,env,once_fixtures,each_fixtures,vec__11372,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_11392)));
});})(seq__11376,chunk__11377,count__11378,i__11379,t_11392,temp__5720__auto___11391__$1,v,seq__11376__$1,temp__5720__auto__,each_fixture_fn,G__11375,G__11375__$1,env,once_fixtures,each_fixtures,vec__11372,ns,vars__$1))
);
} else {
}


var G__11393 = cljs.core.next.call(null,seq__11376__$1);
var G__11394 = null;
var G__11395 = (0);
var G__11396 = (0);
seq__11376 = G__11393;
chunk__11377 = G__11394;
count__11378 = G__11395;
i__11379 = G__11396;
continue;
}
} else {
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__11375__$1)].join('')));
